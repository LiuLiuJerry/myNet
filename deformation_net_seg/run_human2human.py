...
parser.add_argument('--train_hdf5', default='../data_hdf5/human_seg_train.hdf5')
parser.add_argument('--test_hdf5', default='../data_hdf5/human_seg_test.hdf5')
...
#segmentation tags
Tags = txtReader.read_txt("../data_hdf5/seg_human.txt")
