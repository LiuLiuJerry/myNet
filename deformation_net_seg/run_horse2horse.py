...
parser.add_argument('--train_hdf5', default='../data_hdf5/horse_seg_train.hdf5')
parser.add_argument('--test_hdf5', default='../data_hdf5/horse_seg_test.hdf5')
...
parser.add_argument('--epoch', type=int, default=800, help='number of epoches to run [default: 200]')
...
#print('>>>>>>>>>>>>>>point number: ', FLAGS.point_num_in)
