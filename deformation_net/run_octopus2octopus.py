...
parser.add_argument('--train_hdf5', default='../data_hdf5/octopus_train.hdf5')
parser.add_argument('--test_hdf5', default='../data_hdf5/octopus_test.hdf5')
...
parser.add_argument('--epoch', type=int, default=600, help='number of epoches to run [default: 200]')
...
# for learning
parser.add_argument('--LEARNING_RATE_G', type=float, default=0.0001, help='could be changed')
...
def train():
    with tf.Graph().as_default():
        ...
        '''b_load = 1
        if b_load:
            modelPath = 'output_octopus/trained_models'
