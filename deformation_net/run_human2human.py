...
parser.add_argument('--train_hdf5', default='../data_hdf5/human_train.hdf5')
parser.add_argument('--test_hdf5', default='../data_hdf5/human_test.hdf5')
...
parser.add_argument('--epoch', type=int, default=300, help='number of epoches to run [default: 200]')
