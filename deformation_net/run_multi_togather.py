...
parser.add_argument('--train_hdf5', default='../data_hdf5/lioness_horse_train.hdf5')
parser.add_argument('--test_hdf5', default='../data_hdf5/lioness_horse_test.hdf5')
...
##################### output data #######################
output_dir = 'output_multi_togather'
